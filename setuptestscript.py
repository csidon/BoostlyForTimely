...
user2 = User(user_first_name="Testy", user_last_name="Tester", user_email="test@test.com", user_password="$2b$12$6Lxi6jt8RtxNlggq9ugHlusxuDmbydw084Gl5IfQfcSVjERO6vtLu", companyid=1)
db.session.add(user2)
user3 = User(user_first_name="Evan", user_last_name="Master", user_email="evan@user.com", user_password="$2b$12$6Lxi6jt8RtxNlggq9ugHlusxuDmbydw084Gl5IfQfcSVjERO6vtLu", companyid=1)
db.session.add(user3)
userLena = User(user_first_name="Lena", user_last_name="Walton", user_email="LenaWalton.MassageTherapist@gmail.com", user_password="$2b$12$6Lxi6jt8RtxNlggq9ugHlusxuDmbydw084Gl5IfQfcSVjERO6vtLu", companyid=3)
