...
client2 = Client(first_name="Richie", last_name="Rich", email="richie@rich.com", mobile=220220222, status="active")
client3 = Client(first_name="Poke", last_name="Man(e)", email="chris.chonghuihui+poke@gmail.com", mobile=220220222, status="active")
...
client6 = Client(first_name="Rachel", last_name="Latte(e)", email="fakerachellette@gmail.com", mobile=220220222, status="active")
client7 = Client(first_name="Lucas", last_name="Moonwalker(e)", email="fakerachellette@gmail.com", mobile=220220222, status="active")
...
client7.companies.append(coy2)
client8.companies.append(coy2)
client9.companies.append(coy2)
db.session.commit()
