...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = User(user_email=form.userEmail.data, user_last_name=form.userLastName.data, user_first_name=form.userFirstName.data, user_password=hashedPW, companyid=companyid)
