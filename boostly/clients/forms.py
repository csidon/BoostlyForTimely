...
class ClientPrefForm(FlaskForm):
    minDuration = IntegerField('Minimum timeslot (You will receive notifications for anything less than this timeslot. We suggest 30 mins, although you can enter a minimum of 15 mins)', default=60,
