...
application.config['SQLALCHEMY_DATABASE_URI'] = \
    'postgresql://postgresmaster:1NewPass!@s3-lambda-rdspostgresv2.clbvaq8mp9jk.us-east-1.rds.amazonaws.com:5432/boostly_db'    # Chris' RDS
application.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False      

# application.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:1NewPass!@localhost:5432/postgres' # Chris' local
